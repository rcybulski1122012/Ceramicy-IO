...
const saveAnswers = (id: string, url: string, smells: Smell[][]): void => {
  try {
    ...
    if (quizAnswerDataDictString != null) {
      const quizAnswerDataDict: QuizzAnswerDataDict = JSON.parse(
        quizAnswerDataDictString,
      ) as QuizzAnswerDataDict;
...
const saveCorrectAnswersPercent = (
  id: string,
  url: string,
  percent: number,
): void => {
...
const getCorrectAnswersPercent = (
  id: string,
  url: string,
...
export {
  saveAnswers,
  saveCorrectAnswersPercent,
  getAnswers,
  getCorrectAnswersPercent,
  deleteData,
  getName,
  setName,
  deleteName,
